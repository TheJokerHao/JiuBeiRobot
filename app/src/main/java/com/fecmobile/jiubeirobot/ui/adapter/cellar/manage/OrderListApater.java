 ...
 * 修改备注  :  已完成状态添加打印小票
 */
public class OrderListApater extends BaseRecycleAdapter<ManagerOrderListBean.OrderListBean> {
...
//            put("6","已取消");
    ...
    public OrderListApater(Context context, List<ManagerOrderListBean.OrderListBean> list) {
