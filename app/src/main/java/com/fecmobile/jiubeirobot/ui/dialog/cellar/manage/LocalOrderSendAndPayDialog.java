...
public class LocalOrderSendAndPayDialog extends BaseDialogFragment {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_operator1:
                ...
                if (type == 1) {
                    //现金收款
                    APIManager.getInstance().getLocalOrderReceivable(getActivity(), this, orderId, "3");
                } else if (type == 2) {
                    //自提
                    APIManager.getInstance().getLocalOrderSend(getActivity(), this, orderId, orderCode, "1", null, null, null, null);
                }
                break;
            case R.id.btn_operator2:
                ...
                if (type == 1) {
                    //刷卡
                    APIManager.getInstance().getLocalOrderReceivable(getActivity(), this, orderId, "4");
                } else if (type == 2) {
                    //配送，跳转填写发货信息
