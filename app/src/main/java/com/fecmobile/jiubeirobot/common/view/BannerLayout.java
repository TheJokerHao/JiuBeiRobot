...
public class BannerLayout extends RelativeLayout {
    ...
    private FrameLayout getFrameLayoutView(String url, String title, final int position) {
        ...
        L.i("**********************" + url);
        if (fragment != null && url != null) {
            GlideImageLoadImpl.getInstance().load(fragment, url, imageView);
        } else if (activity != null && url != null) {
            GlideImageLoadImpl.getInstance().load(activity, url, imageView);
        }
...
//        }
    ...
    private FrameLayout getFrameLayoutView(Integer res, String title, final int position) {
        ...
        ImageView imageView = new ImageView(getContext());
        frameLayout.addView(imageView);
        frameLayout.setBackgroundColor(titleBGColor);
        frameLayout.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mOnBannerItemClickListener != null) {
