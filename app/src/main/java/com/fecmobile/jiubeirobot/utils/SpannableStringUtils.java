...
import com.fecmobile.jiubeirobot.base.ActivityControl;
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(ActivityControl.getActivityControl().getCurrentAtivity(), bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(ActivityControl.getActivityControl().getCurrentAtivity(), uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new ImageSpan(ActivityControl.getActivityControl().getCurrentAtivity(), resourceId), start, end, flag);
                    resourceId = 0;
