...
/**
 * 自定义的RecyclerView 继承与 RecyclerView 作用还需要进一步查看
 * 这个RecyclerView很好的实现了在listView中常见的实现功能  比如添加头部  添加脚步
 * 实现多布局  单布局  万能适配器  等一系列的操作和功能 很方便
 * Github地址https://github.com/jianghejie/XRecyclerView
 */
...
//        Log.d("print", "onScrollStateChanged: " + " loadingMoreEnabled         " + loadingMoreEnabled);
//        Log.d("print", "onScrollStateChanged: " + " isLoadingData             " + isLoadingData);
//        Log.d("print", "onScrollStateChanged: " + " mLoadingListener           " + mLoadingListener);
//        Log.d("print", "onScrollStateChanged: " + "  RecyclerView.SCROLL_STATE_IDLE                " +  RecyclerView.SCROLL_STATE_IDLE);
