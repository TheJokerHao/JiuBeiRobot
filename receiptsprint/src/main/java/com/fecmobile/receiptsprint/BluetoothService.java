...
public class BluetoothService {
    ...
    public static final int MESSAGE_OFF = 4;//断开
...
//    }
    ...
    private synchronized void setState(int state) {
        ...
        Log.d("print", "setState: " + MainActivity.MESSAGE_STATE_CHANGE);
    }
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    setState(MESSAGE_OFF);
                    Message msg = mHandler.obtainMessage(MESSAGE_OFF);
                    mHandler.sendMessage(msg);
                    break;
                }
