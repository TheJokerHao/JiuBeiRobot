...
public class MainActivity extends Activity {
    ...
    public static final int MESSAGE_OFF = 6;
...
//                sendMessage(t.getLineTitle("盛唐前海酒窖"));
//                sendMessage(" \n");
//                sendMessage("机器号：JQ001\t服务员：134**01");
//                sendMessage(" \n");
//                sendMessage("日期：2017.03.21 18:21:22");
//                sendMessage(" \n =============================\n");
//                int len=2;
//                for (int i = 0; i < len; i++) {
//                    sendMessage("商品名称：科瑞丝曼 KRESSMANN波尔多珍酿红葡萄酒,波尔多AOC 375ml");
//                    sendMessage(" \n");
//                    sendMessage("数 量：2");
//                    sendMessage(" \n");
//                    sendMessage("单 价：￥2800.00");
//                    sendMessage(" \n");
//                    sendMessage("金额：￥2800.00");
//                    if(i!=len-1){
//                        sendMessage(" \n ------------------------------ \n");
//                    }
//                }
//                sendMessage(" \n ==============================\n");
//                sendMessage("总 额：￥2888.88");
//                sendMessage(" \n");
//                sendMessage("折 扣：￥2888.88");
//                sendMessage(" \n");
//                sendMessage("应 付：￥2888.88");
//                sendMessage(" \n");
//                sendMessage(" \n");
//                sendMessage("欢迎下次光临盛唐前海酒窖");
//                sendMessage(" \n");
//                sendMessage(" \n");
//                sendMessage(" \n");
//                sendMessage(" \n");
