package com.fecmobile.pickerview.view;
...
import com.fecmobile.pickerview.R;
 ...
 */
public class BasePickerView2<T> implements View.OnClickListener {
    ...
    private BasePickerView2.OnOptionsSelectListener optionsSelectListener;

    private String Str_Submit;//确定按钮文字
    private String Str_Cancel;//取消按钮文字
    private String Str_Title;//标题文字

    private ColorStateList Color_Submit;
    private ColorStateList Color_Cancel;
    ...
    private BasePickerView2.Builder builder;
    ...
    protected int bgColor_default = 0xFFEEEEEE;
    private ViewGroup contentContainer;

    public void setCancelOnclick(View.OnClickListener onclick) {
        btnCancel.setOnClickListener(onclick);
    }

    public BasePickerView2(Context context, ViewGroup contentContainer, BasePickerView2.Builder builder) {
    ...
    protected void initViews() {
        ...
        contentView = layoutInflater.inflate(R.layout.pickerview_options, contentContainer);
        //顶部标题
        ...
        // ----转轮
        final LinearLayout optionsPicker = (LinearLayout) contentView.findViewById(R.id.optionspicker);
        RelativeLayout rv_top_bar = (RelativeLayout) contentView.findViewById(R.id.rv_topbar);
    ...
    public static class Builder {
        ...
        private ColorStateList Color_Submit;//确定按钮颜色
        private ColorStateList Color_Cancel;//取消按钮颜色
        private int Color_Title;//标题颜色

        private int Color_Background_Wheel;//滚轮背景颜色
        private int Color_Background_Title;//标题背景颜色

        private int Size_Submit_Cancel = 18;//确定取消按钮大小
        ...
        public Builder setSubmitColor(ColorStateList Color_Submit) {
            this.Color_Submit = Color_Submit;
            return this;
        }

        public Builder setCancelColor(ColorStateList Color_Cancel) {
        ...
        public BasePickerView2 build(ViewGroup contentContainer) {
            return new BasePickerView2(context, contentContainer, this);
        }
    }
